...
static Cluster door1_in_clusters[] = {
    Cluster(BASIC_CLUSTER_ID, door1_basic_attr, sizeof(door1_basic_attr)),
    Cluster(ON_OFF_CLUSTER_ID, door1_attr, sizeof(door1_attr))};
static Cluster door2_in_clusters[] = {
    Cluster(BASIC_CLUSTER_ID, door2_basic_attr, sizeof(door2_basic_attr)),
    Cluster(ON_OFF_CLUSTER_ID, door2_attr, sizeof(door2_attr))};
static Cluster door3_in_clusters[] = {
    Cluster(BASIC_CLUSTER_ID, door3_basic_attr, sizeof(door3_basic_attr)),
    Cluster(ON_OFF_CLUSTER_ID, door3_attr, sizeof(door3_attr))};
static Cluster door4_in_clusters[] = {
    Cluster(BASIC_CLUSTER_ID, door4_basic_attr, sizeof(door4_basic_attr)),
    Cluster(ON_OFF_CLUSTER_ID, door4_attr, sizeof(door4_attr))};
...
static Endpoint ENDPOINTS[NUM_ENDPOINTS] = {
    Endpoint(1, ON_OFF_OUTPUT, door1_in_clusters, out_clusters, sizeof(door1_in_clusters), 0),
    Endpoint(2, ON_OFF_OUTPUT, door2_in_clusters, out_clusters, sizeof(door2_in_clusters), 0),
    Endpoint(3, ON_OFF_OUTPUT, door3_in_clusters, out_clusters, sizeof(door3_in_clusters), 0),
    Endpoint(4, ON_OFF_OUTPUT, door4_in_clusters, out_clusters, sizeof(door4_in_clusters), 0),
    Endpoint(5, TEMPERATURE_SENSOR, t_in_clusters, out_clusters, sizeof(t_in_clusters), 0),
};
